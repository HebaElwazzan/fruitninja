...
public class Watermelon extends NormalFruit{
	...
	public BufferedImage[] getBufferedImages() throws IOException {
		...
		File image = new File("E:\\Java\\EclipseWorkspace\\Assignment_3_6521_6492_6441\\fruitninja\\resources\\images\\watermelon.png");
		fruitImages[0] = ImageIO.read(image);
		image = new File("E:\\Java\\EclipseWorkspace\\Assignment_3_6521_6492_6441\\fruitninja\\resources\\images\\slicedWatermelon.png");
